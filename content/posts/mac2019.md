...
-   <span class="kwd">Lemon</span>：垃圾清理，软件卸载，取代 CleanMyMac
...
-   <span class="kwd">iTerms2</span>、<span class="kwd">zsh</span>、<span class="kwd">oh-my-zsh</span>：命令行相关，见下
...
-   <span class="kwd">Find My</span>：跟踪 Apple 设备，防止遗失
-   <span class="kwd">Folx</span>：各种下载
-   <span class="kwd">GoodNote</span>：手写体笔记
-   <span class="kwd">magnetw</span>：开源种子搜索神器 👍🏻
...
-   [零度解说](https://www.freedidi.com/)：各种免费资源，开车资源 💎💎💎
